...
const title = computed(() => (props.mode === "create" ? "Add Block" : "Edit Block"))
    ...
    <DialogContent class="sm:max-w-lg">
      ...
      <div class="grid gap-4 py-2">
        ...
        <div class="grid gap-2">
          ...
          <Input v-model="local.name" placeholder="e.g. Block A" :disabled="!canMutate" />
