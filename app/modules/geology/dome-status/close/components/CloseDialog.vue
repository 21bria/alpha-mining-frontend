...
const emit = defineEmits<{
  ...
  (e: "submit", payload: DomeClosePayload): void
}>()
...
const local = ref<DomeCloseFormState>({
  id: undefined,
  dome: null,
  tonnage_dome: "",
  status_dome: "Close",
...
function submit() {
  const payload: DomeClosePayload = {
    id: local.value.id,
