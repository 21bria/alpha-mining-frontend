...
type ColumnActions = {
  onView?: (row: DomeTransferRow) => void
  onUndo?: (row: DomeTransferRow) => void
  onDelete?: (row: DomeTransferRow) => void
}
      ...
      ? [
        {
          ...
          cell: ({ row }: { row: { original: DomeTransferRow } }) =>
