...
const material = ref<string | null>("-")
...
const endpoint = "/api/analytics/raw/compile/export/coa/xlsx/"
...
function buildParams() {
  ...
  if (type.value === "range") {
    ...
    if (diffDays > 31) {
      notify.error("Maximum only 31 days allowed")
      return null
    }
...
<div class="grid grid-cols-2 gap-2 max-w-md space-y-2 mb-4">
      ...
      <!-- Material -->
      <div class="space-y-2">
        <label class="font-medium block">Materials</label>
