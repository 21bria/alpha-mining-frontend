...
async function fetchPlotData() {
  ...
  try {
    const res = await request<PlotResponse>(
      "/api/analytics/raw/geology/sample-crm-roa/plot-data",
      {
        method: "GET",
        query: {
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
      ...
      <div class="rounded-xl border p-3 space-y-3">
        <div class="flex items-start justify-between gap-3">
          <div>
            <h3 class="text-base font-semibold">ROA - Ni Analysis</h3>
            <p class="text-xs text-muted-foreground">
              Comparison between CRM and ROA for Ni
            </p>
          </div>
      ...
      <div class="rounded-xl border p-3 space-y-3">
        <div class="flex items-start justify-between gap-3">
          <div>
            <h3 class="text-base font-semibold">ROA - Fe Analysis</h3>
            <p class="text-xs text-muted-foreground">
              Comparison between CRM and ROA for Fe
            </p>
          </div>
      ...
      <div class="rounded-xl border p-3 space-y-3">
        <div class="flex items-start justify-between gap-3">
          <div>
            <h3 class="text-base font-semibold">ROA - MgO Analysis</h3>
            <p class="text-xs text-muted-foreground">
              Comparison between CRM and ROA for MgO
            </p>
          </div>
      ...
      <div class="rounded-xl border p-3 space-y-3">
        <div class="flex items-start justify-between gap-3">
          <div>
            <h3 class="text-base font-semibold">ROA - SiO2 Analysis</h3>
            <p class="text-xs text-muted-foreground">
              Comparison between CRM and ROA for SiO2
            </p>
          </div>
