  ...
  <CommandDialog v-model:open="openCommand">
    ...
    <CommandList>
      ...
      <CommandGroup heading="Suggestions">
        ...
        <CommandItem value="inventory" @select="handleSelectLink('/inventory')">
          Inventory
          <CommandShortcut>
            <Kbd>G</Kbd>
            <Kbd>I</Kbd>
      ...
      <CommandGroup heading="Components">
        <CommandItem v-for="nav in componentsNav?.children" :key="nav.title" :value="nav.title" class="gap-2"
