...
const search = ref("")
const activeCategory = ref("All Master")
const openGroups = ref<string[]>([])

const categories = ["All Master", "Sources", "Materials", "Equipment", "Sample", "Geology"]
...
const permittedMasterItems = computed(() => {
  return filterNavMenuItems(masterItems as any, userPerms.value)
})
...
const filteredItems = computed(() => {
  ...
  if (activeCategory.value !== "All Master") {
        ...
        <div class="flex items-start justify-between gap-4">
          <div>
            ...
            <p class="text-sm text-muted-foreground">
              Browse and access all master data modules
            </p>
          </div>
