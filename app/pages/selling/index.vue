...
import { masterItems } from "~/constants/menus/master-items"
...
import { sellingItems } from "~/constants/menus/selling-items"

const activeCategory = ref("All Selling")
const categories = ["All Selling",  "Blending", "Adjustment", "Master"]
...
const permittedSellingItems = computed(() => {
  return filterNavMenuItems(sellingItems as any, userPerms.value)
})
...
const safeSellingItems = computed(() => {
  return permittedSellingItems.value.map((item: any) => {
    const children =
      "children" in item
...
const filteredItems = computed(() => {
  ...
  let items = safeSellingItems.value

  if (activeCategory.value !== "All Selling") {
      ...
      <div class="flex flex-col gap-4 border-b pb-4">
        <div class="flex items-start justify-between gap-4">
          <div>
            ...
            <p class="text-sm text-muted-foreground">
              Browse and access all selling data modules
            </p>
          </div>
        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div class="relative w-full lg:w-[380px]">
            ...
            <input
              v-model="search"
              placeholder="Search selling data"
